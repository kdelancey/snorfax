    ...
    if ( htmlObj is not None ):
      ...
      #Snorfax
        ...
        if snorfaxtxt is not None and len(snorfaxtxt) != 0: #if fax is not bad
          ...
          await self.bot.say("\\:snorfax: <:264215284758347776:> \\<:264215284758347776:> \<:264215284758347776:> <:snorfax:264215284758347776> \\<:snorfax:264215284758347776> \<:snorfax:264215284758347776> :heart: \r")
